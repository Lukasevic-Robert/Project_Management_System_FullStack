...
public interface ProjectRepository extends JpaRepository<Project, Long> {
	...
	@Query(value = "SELECT * FROM projects WHERE UPPER(name) LIKE %:keyword% OR UPPER(description) LIKE %:keyword%", nativeQuery = true)
	Page<Project>findPaginatedProjectsByKeyword(Pageable pageable, @Param("keyword") String keyword);
